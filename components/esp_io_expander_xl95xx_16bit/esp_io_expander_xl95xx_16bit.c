...
#include "esp_io_expander_xl95xx_16bit.h"
...
} esp_io_expander_xl95xx_16bit_t;

static char *TAG = "xl95xx_16";
...
esp_err_t esp_io_expander_new_i2c_xl95xx_16bit(i2c_master_bus_handle_t i2c_bus, uint32_t dev_addr, esp_io_expander_handle_t *handle_ret)
{
    ESP_RETURN_ON_FALSE(handle_ret != NULL, ESP_ERR_INVALID_ARG, TAG, "Invalid handle_ret");

    // Allocate memory for driver object
    esp_io_expander_xl95xx_16bit_t *tca = (esp_io_expander_xl95xx_16bit_t *)calloc(1, sizeof(esp_io_expander_xl95xx_16bit_t));
...
static esp_err_t read_input_reg(esp_io_expander_handle_t handle, uint32_t *value)
{
    esp_io_expander_xl95xx_16bit_t *tca = (esp_io_expander_xl95xx_16bit_t *)__containerof(handle, esp_io_expander_xl95xx_16bit_t, base);
